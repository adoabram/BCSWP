...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme-general-css', ALETHEME_THEME_URL . '/css/style.css', array(), ALETHEME_THEME_VERSION, 'all');
	...
	//Register libs
	wp_register_style( 'font-awesome', ALETHEME_THEME_URL . '/css/all.min.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'slick', ALETHEME_THEME_URL . '/css/slick.css', array(), ALETHEME_THEME_VERSION, 'all');
